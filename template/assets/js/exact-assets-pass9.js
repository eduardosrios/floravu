(function () {
  ...
  function applySection18() {
    ...
    target.innerHTML = [
      ...
      "<div class='container xr18-service-cards'><div class='row'><div class='col-12 col-md-4'><article class='card'><img src='assets/images/semantic/s18-photo-1.jpg' alt='Landscape designer working beside a pool'><div class='xr18-service-copy'><span class='xr18-service-icon'><i class='fa-solid fa-compass-drafting' aria-hidden='true'></i></span><div class='xr18-service-text'><h3>Landscape Design</h3><p>Our team of experienced staff work.</p></div><a href='#services' aria-label='Explore Landscape Design'><i class='fa-solid fa-arrow-right' aria-hidden='true'></i></a></div></article></div><div class='col-12 col-md-4'><article class='card'><img src='assets/images/semantic/s18-photo-2.jpg' alt='Gardening specialist planning seasonal planting'><div class='xr18-service-copy'><span class='xr18-service-icon'><i class='fa-solid fa-seedling' aria-hidden='true'></i></span><div class='xr18-service-text'><h3>Seasonal Plantings</h3><p>Our team of experienced staff work.</p></div><a href='#services' aria-label='Explore Seasonal Plantings'><i class='fa-solid fa-arrow-right' aria-hidden='true'></i></a></div></article></div><div class='col-12 col-md-4'><article class='card'><img src='assets/images/semantic/s18-photo-3.jpg' alt='Gardener renovating a planting bed'><div class='xr18-service-copy'><span class='xr18-service-icon'><i class='fa-solid fa-plant-wilt' aria-hidden='true'></i></span><div class='xr18-service-text'><h3>Garden Renovation</h3><p>Our team of experienced staff work.</p></div><a href='#services' aria-label='Explore Garden Renovation'><i class='fa-solid fa-arrow-right' aria-hidden='true'></i></a></div></article></div></div></div>",
