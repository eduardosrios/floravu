(function () {
  ...
  T[24] = `<div class='xr xr-24'><header><small>OUR SERVICES</small><h2>What Can We Offer</h2><p>Complete landscape services, delivered with thoughtful planning and a practical point of view.</p></header><div class='xr-offer-row'>
    <article><b>01</b>${ico('pen-ruler')}<h3>Garden Design</h3><p>We create plans that fit the site and the people using it.</p><a href=#contact>+ READ MORE</a></article>
    <article><b>02</b>${ico('faucet-drip')}<h3>Irrigation System</h3><p>Efficient watering for healthier, lower-maintenance beds.</p><a href=#contact>+ READ MORE</a></article>
    <article><b>03</b>${ico('tree')}<h3>Tree Services</h3><p>Careful pruning, health checks, and seasonal support.</p><a href=#contact>+ READ MORE</a></article>
    <article><b>04</b>${ico('scissors')}<h3>Hedge Cutting</h3><p>Clean structure with respect for healthy new growth.</p><a href=#contact>+ READ MORE</a></article>
  </div></div>`;
  ...
  T[28] = `<div class='xr xr-28'><header><small>ABOUT US</small><h2>Growing Green Together</h2><p>At Floravu, we grow more than gardens. We create lasting spaces for families, neighborhoods, and local habitats.</p></header><div class='xr-stat-story'><article><b>130+</b><span>Satisfied Customers</span>${im('family','Garden family')}</article><figure>${im('garden','Garden project')}</figure><article class=green><b>3k+</b><span>Unique projects</span>${im('pot','Plant')}</article><article><b>20+</b><span>Service Providers</span>${im('work','Garden care')}</article></div></div>`;
  ...
  T[104] = `<div class='xr xr-104'><header><h2>Bestsellers</h2><nav><button>⟵</button><button>⟶</button></nav></header><div class='xr-bestsellers'><article>${im('greenhouse','Monstera Deliciosa')}<h3>Monstera Deliciosa plant</h3><p>₹2000/- <del>₹2199/-</del></p><button>Buy Now</button><button>Add cart</button></article><article>${im('plant','Bamboo plant')}<h3>Bamboo plant</h3><p>₹1200/- <del>₹1499/-</del></p><button>Buy Now</button><button>Add cart</button></article><article>${im('pot','Money plant')}<h3>Money plant</h3><p>₹2000/- <del>₹2199/-</del></p><button>Buy Now</button><button>Add cart</button></article><article>${im('leaf','Snake plant')}<h3>Snake plant</h3><p>₹1300/- <del>₹1499/-</del></p><button>Buy Now</button><button>Add cart</button></article></div></div>`;
  ...
  T[112] = `<div class='xr xr-112'><div class='xr-landscape-copy'><small>What We Do</small><h2>We offer Landscape<br>Services.</h2><p>Explore garden design, planting, maintenance, and careful landscape improvements for every kind of outdoor space.</p><a href=#services>VIEW ALL SERVICES</a></div><div class='xr-landscape-cards'><article>${ico('screwdriver-wrench')}<h3>Maintenance</h3><p>Weekly and seasonal upkeep.</p></article><article>${ico('pen-ruler')}<h3>Garden Design</h3><p>Clear plans shaped around your property.</p></article><article>${ico('seedling')}<h3>Planting</h3><p>Layered palettes with long-term health.</p></article><article>${ico('water')}<h3>Fence Cleaning</h3><p>Refresh boundaries and hard surfaces.</p></article></div></div>`;
  ...
  T[137] = `<div class='xr xr-137'><div class='xr-sustainable-copy'><h2>Create<br>sustainable<br>future</h2><p>Buy One. Plant one.</p><span>${ico('circle')} Scroll down</span></div><div class='xr-sustainable-mosaic'><small>Our top<br>picks</small><img class='c1' src='assets/images/exact/s137-card-1.jpg' alt='Sustainable plant selection card 1'><img class='c2' src='assets/images/exact/s137-card-2.jpg' alt='Sustainable plant selection card 2'><img class='c3' src='assets/images/exact/s137-card-3.jpg' alt='Sustainable plant selection card 3'><img class='c4' src='assets/images/exact/s137-card-4.jpg' alt='Sustainable plant selection card 4'><img class='c5' src='assets/images/exact/s137-card-5.jpg' alt='Sustainable plant selection card 5'></div></div>`;
