(function ($) {
  ...
  var img = {
    ...
    bench: "https://images.unsplash.com/photo-1598902108854-10e335adac99?auto=format&fit=crop&w=900&q=80",
    work: "https://images.unsplash.com/photo-1591857177580-dc82b9ac4e1e?auto=format&fit=crop&w=900&q=80",
    path: "https://images.unsplash.com/photo-1466692476868-aef1dfb1e735?auto=format&fit=crop&w=900&q=80",
    pot: "https://images.unsplash.com/photo-1485955900006-10f4d324d411?auto=format&fit=crop&w=900&q=80",
    indoor: "https://images.unsplash.com/photo-1501004318641-b39e6451bec6?auto=format&fit=crop&w=900&q=80",
    leaf: "https://images.unsplash.com/photo-1512428813834-c702c7702b78?auto=format&fit=crop&w=900&q=80",
    hands: "https://images.unsplash.com/photo-1520412099551-62b6bafeb5bb?auto=format&fit=crop&w=900&q=80",
    woman: "https://images.unsplash.com/photo-1523348837708-15d4a09cfac2?auto=format&fit=crop&w=900&q=80",
    garden: "https://images.unsplash.com/photo-1500530855697-b586d89ba3ee?auto=format&fit=crop&w=1400&q=80",
    tools: "https://images.unsplash.com/photo-1558904541-efa843a96f01?auto=format&fit=crop&w=900&q=80",
    mow: "https://images.unsplash.com/photo-1586280268958-9483002d016a?auto=format&fit=crop&w=900&q=80"
  };
  ...
  html += sec(13, 'guide', '<div class="guide-card"><img src="' + img.work + '" alt="Plant care"><div><p>Easy tips and tricks to keep your plants healthy and thriving.</p><article><b>01</b><h3>Watering Tips</h3><span>Avoid overwatering.</span></article><article><b>02</b><h3>Light Requirements</h3><span>Prefer bright indirect light.</span></article><article><b>03</b><h3>Soil and Fertilizer</h3><span>Feed monthly.</span></article></div></div>');
  ...
  html += sec(20, 'gallery', heading('Project', 'Our Best Work', '') + '<div class="filter-tabs"><button class="active" data-filter="all" type="button">All</button><button data-filter="garden" type="button">Garden Care</button><button data-filter="lawn" type="button">Lawn Care</button><button data-filter="planting" type="button">Planting</button></div><div class="gallery-grid"><img data-cat="garden" src="' + img.tools + '" alt="Pruning"><img data-cat="planting" src="' + img.work + '" alt="Planting"><img data-cat="lawn" src="' + img.mow + '" alt="Mowing"><img data-cat="garden" src="' + img.path + '" alt="Path"><img data-cat="planting" src="' + img.woman + '" alt="Greenhouse"><img data-cat="lawn" src="' + img.garden + '" alt="Lawn"></div>');
  html += videoBlock(20, 'Project field motion', 'A video duplicate for the project gallery area.', 'https://videos.pexels.com/video-files/7655570/7655570-uhd_3840_2160_25fps.mp4');
  ...
  html += videoBlock(23, 'Professional care motion', 'A video duplicate for garden care services.', 'https://videos.pexels.com/video-files/37562759/15916646_1080_1920_30fps.mp4');
  ...
  html += sec(33, 'beauty', '<div class="beauty-grid"><div><h2>Cultivating Beauty in Every Season</h2><p>Spring growth, summer heat, autumn reset, winter protection.</p><a class="tiny-btn green" href="#contact">Learn More</a></div><img src="' + img.path + '" alt="Garden season"><img src="' + img.tools + '" alt="Gardener"></div>');
  html += sec(34, 'solution', '<div class="solution-hero"><img src="' + img.garden + '" alt="Outdoor landscape"><h2>Complete Landscaping Solutions for Every Outdoor Space</h2></div><div class="solution-grid"><article class="active">' + icon('drafting-compass') + '<h3>Landscape Design and Installation</h3><p>Custom landscapes for patios and lawns.</p></article><article>' + icon('seedling') + '<h3>Garden Maintenance</h3><p>Seasonal pruning and soil health.</p></article><article>' + icon('droplet') + '<h3>Irrigation Systems</h3><p>Efficient watering controls.</p></article><article>' + icon('house-chimney-window') + '<h3>Outdoor Living and Hardscaping</h3><p>Patios, paths, and seating.</p></article></div>');
  html += videoBlock(34, 'Greenhouse pathway motion', 'A video duplicate for complete landscape solutions.', 'https://videos.pexels.com/video-files/34918439/14791435_1080_1920_30fps.mp4');
